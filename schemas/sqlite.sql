...
CREATE TABLE IF NOT EXISTS "players" (
	...
	"health_skill" INT(11) NOT NULL DEFAULT 0,
	"mana_skill" INT(11) NOT NULL DEFAULT 0,
	"bend_skill" INT(11) NOT NULL DEFAULT 0,
	"dodge_skill" INT(11) NOT NULL DEFAULT 0,
	"resets" INT(11) NOT NULL DEFAULT 0,
	"skill_points" INT(11) NOT NULL DEFAULT 0,
	"online_time" INT(11) NOT NULL DEFAULT 0,
	"age" INT(11) NOT NULL DEFAULT 0,
	"age_minutes" INT(11) NOT NULL DEFAULT 0,
	UNIQUE ("name", "deleted"),
...
CREATE TABLE IF NOT EXISTS "monster_boost" (
  "id" INTEGER PRIMARY KEY AUTOINCREMENT,
