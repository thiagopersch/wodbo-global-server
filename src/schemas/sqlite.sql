...
CREATE TABLE "players" (
	...
	"lookwings" INTEGER NOT NULL DEFAULT 0,
	"lookaura" INTEGER NOT NULL DEFAULT 0,
	"lookshader" INTEGER NOT NULL DEFAULT 0,
	"lookhealthbar" INTEGER NOT NULL DEFAULT 0,
	"lookmanabar" INTEGER NOT NULL DEFAULT 0,
