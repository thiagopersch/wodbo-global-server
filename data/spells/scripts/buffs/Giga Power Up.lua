...
setConditionParam(condition, CONDITION_PARAM_SKILL_FIST, 14)
setConditionParam(condition, CONDITION_PARAM_SKILL_CLUB, 14)
setConditionParam(condition, CONDITION_PARAM_SKILL_SWORD, 14)
setConditionParam(condition, CONDITION_PARAM_SKILL_AXE, 14)
setConditionParam(condition, CONDITION_PARAM_SKILL_DISTANCE, 14)
setConditionParam(condition, CONDITION_PARAM_SKILL_SHIELD, 14)
setConditionParam(condition, CONDITION_PARAM_STAT_MAGICLEVEL, 14)
