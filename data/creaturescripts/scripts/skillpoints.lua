...
--   doPlayerSendExtendedOpcode(cid, SKILL_POINTS_OPCODE_INIT, message)
-- end
...
--     doPlayerSendExtendedOpcode(cid, SKILL_POINTS_OPCODE_PENDING, tostring(points))
--     return true
--   end
...
--     doPlayerSendExtendedOpcode(cid, SKILL_POINTS_OPCODE_UPDATE,
